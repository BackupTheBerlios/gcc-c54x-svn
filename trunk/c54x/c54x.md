...
(define_insn "*stlm"
  [(set (match_operand:QI 0 "register_operand" "=z")
		(match_operand:QI 1 "acc_register_operand" ""))]
""
"stlm\t%1, %0")
...
(define_insn "ld_const"
  [(set (match_operand:PSI 0 "acc_register_operand" "")
		(ashift:PSI (zero_extend:PSI (match_operand:QI 1 "immediate_operand" "I"))
...
(define_insn "*mvmm"
  [(set (match_operand:QI 0 "mmr_register_operand" "")
		(match_operand:QI 1 "mmr_register_operand" ""))]
""
"mvmm\t%1, %0")
...
(define_expand "addqi3"
  [(set (match_operand:QI 0 "acc_register_operand" "")
		(plus:QI (match_dup 0)
				 (match_operand:QI 1 "general_operand" "")))]
""
"
{
fprintf(stderr, \"{{{\");
print_rtl(stderr, operands[0]);
print_rtl(stderr, operands[1]);
print_rtl(stderr, operands[2]);
fprintf(stderr, \"}}}\");
...
(define_insn "*addm"
  [(set (match_operand:QI 0 "smem_operand" "=T")
		(plus:QI (match_dup 0)
				 (match_operand:QI 1 "immediate_operand" "I")))]
""
"addm\t%0, %1")
